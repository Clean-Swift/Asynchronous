...
class HomeViewController: UIViewController, HomeDisplayLogic
{
  ...
  func displayCompletionHandler(viewModel: Home.CompletionHandler.ViewModel)
  {
    completionHandlerLabel.text = viewModel.result
  }
  ...
  func displayVIPCycle(viewModel: Home.VIPCycle.ViewModel)
  {
    vipCycleLabel.text = viewModel.result
  }
}
